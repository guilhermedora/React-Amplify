...
export declare type ProfileCardOverridesProps = {
    ...
    "Guilherme Oliveira"?: PrimitiveOverrideProps<TextProps>;
    "Software Engineer at 3DGEO"?: PrimitiveOverrideProps<TextProps>;
    Followers?: PrimitiveOverrideProps<FlexProps>;
    Logo?: LogoProps;
    "Working in Amplify"?: PrimitiveOverrideProps<TextProps>;
} & EscapeHatchProps;
